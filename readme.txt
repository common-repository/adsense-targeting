...
1. Upload the `adsense-targeting` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Ready, no customization needed
...
2. The shortcode is wrapped around the selection
...
Description of the editor button fixed; WP 4.5 ready